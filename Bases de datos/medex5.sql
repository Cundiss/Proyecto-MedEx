...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-09-2024 a las 16:11:28
...
(33, 0, 'facundo', 'carignani', 22, '14124214', 'IO', 'facucari@gmail.com', '14214124124'),
(34, 0, 'tomas', 'angelico', 2, '55006600', 'OSDE', 'ludi@gmail.com', '3364009977'),
(35, 0, 'manuel', 'costoya', 22, '40404040', 'IOMA', 'manu@gmail.com', '3364009988'),
(36, 0, 'santiago', 'forno', 19, '45987903', 'OSAP', 'fornosantiago@gmail.com', '3364607112');
...
(20, 33, 0, '2024-09-04', '13:30:00'),
(21, 34, 0, '2024-09-04', '14:30:00');
...
--
ALTER TABLE `atendidos`
  MODIFY `atendido_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `pacientes`
  MODIFY `paciente_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;

--
-- AUTO_INCREMENT de la tabla `pacientes_eliminados`
--
ALTER TABLE `pacientes_eliminados`
  MODIFY `paciente_eliminado_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT de la tabla `turnos`
--
ALTER TABLE `turnos`
  MODIFY `turno_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
COMMIT;
