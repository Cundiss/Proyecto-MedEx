...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-09-2024 a las 21:49:45
...
(3, 'Pepinillo', 'dasdas@gmail.com', '$2y$10$mxaAOUDgZwu9ziqNfZgp4uxMk8DdERLybf4ew5tVXlFlD8H0C6Ifq', 'medico');
...
(67, 1, 0, 'OOOOOOOOOOOOOOOOOO', 'LLLLLLLLLLLLLLLLLLLLLLLL', 222, '14124214', 'IOMA', 'kaka@gmail.com', '14214124124'),
(69, 2, 0, 'Franco', 'Locaso', 23, '14124214', 'IOM', 'ElGilberXD@gmail.com', '1421412412'),
(71, 2, 0, 'Maria', 'Moffa', 23, '14124214', 'IOMA', 'maria@gmail.com', '1421412');
...
(35, 0, 0, 2, 'Facundo', 'carignani', 43, '14124214', 'IOMA', 'ElGilberXD@gmail.com', '1421412412');
...
--
-- Volcado de datos para la tabla `pacientes_eliminados_historial`
--

INSERT INTO `pacientes_eliminados_historial` (`historial_id`, `paciente_id`, `medico_id`, `descripcion`, `fecha`) VALUES
(2, 66, 2, 'fafafafaf', '2024-09-25'),
(3, 66, 2, 'fafas', '2024-09-25');
...
--
ALTER TABLE `pacientes`
  MODIFY `paciente_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=72;

--
-- AUTO_INCREMENT de la tabla `pacientes_eliminados`
--
ALTER TABLE `pacientes_eliminados`
  MODIFY `paciente_eliminado_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
...
--
ALTER TABLE `paciente_medico`
  ADD CONSTRAINT `paciente_medico_ibfk_1` FOREIGN KEY (`paciente_id`) REFERENCES `pacientes` (`paciente_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `paciente_medico_ibfk_2` FOREIGN KEY (`medico_id`) REFERENCES `medicos` (`medico_id`) ON DELETE CASCADE;
COMMIT;
