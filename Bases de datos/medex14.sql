...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-10-2024 a las 16:58:41
...
(28, 89, 2, '2024-10-18 16:17:08', 'Franco', 'Locaso', '1412', ''),
(30, 89, 2, '2024-10-18 16:17:09', 'Franco', 'Locaso', '1412', '');
...
(90, 2, 0, 'Gilberto', 'Locaso', 23, '35235235', 'OSAP', 'franco@gmail.com', '148678686786786');
...
(51, 86, 0, 2, 'Gilberto', 'Locaso', 23, '35235235', 'IOMA', 'dasdas@gmail.com', '1421412412'),
...
(57, 93, 0, 2, 'facundo', 'c', 342, '2442', 'sdg', 'seg@532', '523235');
...
(62, 89, 0, '2024-10-02', '10:00:00'),
(65, 90, 0, '2024-10-01', '10:00:00'),
(66, 89, 0, '2024-10-03', '10:00:00');
...
--
ALTER TABLE `atendidos`
  MODIFY `atendido_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;

--
-- AUTO_INCREMENT de la tabla `historial`
--
ALTER TABLE `historial`
  MODIFY `historial_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;

--
-- AUTO_INCREMENT de la tabla `medicos`
--
ALTER TABLE `medicos`
  MODIFY `medico_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT de la tabla `pacientes`
--
ALTER TABLE `pacientes`
  MODIFY `paciente_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=94;
...
--
ALTER TABLE `turnos`
  MODIFY `turno_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=72;
COMMIT;
