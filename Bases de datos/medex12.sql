...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-09-2024 a las 16:24:46
...
(85, 2, 0, 'Franco', 'Locaso', 23, '14124214', 'IOM', 'ElGilberXD@gmail.com', '1421412412');
...
--
ALTER TABLE `historial`
  MODIFY `historial_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;
...
--
ALTER TABLE `pacientes`
  MODIFY `paciente_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=86;

--
-- AUTO_INCREMENT de la tabla `pacientes_eliminados`
--
ALTER TABLE `pacientes_eliminados`
  MODIFY `paciente_eliminado_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;
