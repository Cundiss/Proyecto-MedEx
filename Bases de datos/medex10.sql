...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-09-2024 a las 21:13:20
...
(64, 2, 'Maria', 'Moffa', 23, '14124214', 'IOMA', 'maria@gmail.com', '1421412'),
(65, 2, 'Franco', 'Locaso', 23, '14124214', 'IOM', 'ElGilberXD@gmail.com', '1421412412'),
(66, 2, 'Facundo', 'carignani', 43, '14124214', 'IOMA', 'ElGilberXD@gmail.com', '1421412412');
...
ALTER TABLE `pacientes_medicos`
  ADD PRIMARY KEY (`paciente_id`,`medico_id`),
...
--
ALTER TABLE `pacientes`
  MODIFY `paciente_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=67;
...
--
-- Filtros para la tabla `pacientes_medicos`
--
ALTER TABLE `pacientes_medicos`
  ADD CONSTRAINT `pacientes_medicos_ibfk_1` FOREIGN KEY (`paciente_id`) REFERENCES `pacientes` (`paciente_id`),
  ADD CONSTRAINT `pacientes_medicos_ibfk_2` FOREIGN KEY (`medico_id`) REFERENCES `medicos` (`medico_id`);
COMMIT;
