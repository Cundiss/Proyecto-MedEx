...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-09-2024 a las 00:55:27
...
(18, 0, 'manuel', 'costoya', 22, '40404040', 'IOMA', 'manu@gmail.com', '3364009988'),
(22, 0, 'tomas', 'angelico', 2, '55006600', 'OSDE', 'ludi@gmail.com', '3364009977'),
(23, 0, 'lionel', 'messi', 68, '34876543', 'INTER', 'messi@gmail.com', '336408067');
...
--
ALTER TABLE `pacientes`
  MODIFY `paciente_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;

--
-- AUTO_INCREMENT de la tabla `pacientes_eliminados`
--
ALTER TABLE `pacientes_eliminados`
  MODIFY `paciente_eliminado_id` int(11) NOT NULL AUTO_INCREMENT;
